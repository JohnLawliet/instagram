...
const Modal = () => {
    ...
    const uploadPost = async () => {
        ...
        // 4.   get a dowbload URL from fb storage and upadate the original post with image
    ...
    const addImageToPost = (e) => {
        // initializing to read image object
        const reader = new FileReader()
        if (e.target.files[0]){
            reader.readAsDataURL(e.target.files[0])
        }

        // readAsDataUrl launches read.onload after completion.
        // it spits out a format which can be saved as an object in state
    ...
    return (
        <Transition.Root show={open} as={Fragment}>
            <Dialog
                ...
                onClose={setOpen}
            >
                <div className="flex items-end justify-center text-center pb-20 px-4 pt-4 min-h-[800px] sm:block sm:p-0 sm:min-h-screen">
                    <Transition.Child
                        as={Fragment}
                    ...
                    {/*This element tricks browser to centering modal contents*/}
                    <span
                            ...
                            <div>
                                ...
                                <div>
                                    <div className="mt-3 text-center sm:mt-5">
                                        <Dialog.Title 
                                        as="h3" 
                                        className="text-lg leading-6 font-medium text-gray-900">Upload a photo</Dialog.Title>
                                    </div>     
                                    <div>
                                        <input 
                                            ref={filePickerRef}
